...
DBM = {
	Revision = parseCurseDate("20240709143455"),
	DisplayVersion = "11.2.0", -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 07, 09) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
