...
DBM = {
	Revision = parseCurseDate("20241115184901"),
	DisplayVersion = "11.4.6 alpha3", -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 11, 15, 18, 49, 01) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
