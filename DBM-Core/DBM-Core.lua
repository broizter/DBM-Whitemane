...
DBM = {
	Revision = parseCurseDate("20240717221324"),
	DisplayVersion = "11.3.3", -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 07, 17) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
