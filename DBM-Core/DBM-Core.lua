...
DBM = {
	Revision = parseCurseDate("20240710114850"),
	DisplayVersion = "11.3.0", -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 07, 10) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
