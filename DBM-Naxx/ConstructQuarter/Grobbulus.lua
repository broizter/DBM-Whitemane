...
local timerSlimeSprayCD		= mod:NewCDTimer(15, 54364, nil, nil, nil, 2) -- Transcriptor snippet below
...
function mod:OnCombatStart(delay)
	...
	timerSlimeSprayCD:Start(10) -- REVIEW! variance? (25man Lordaeron 2022/10/16) - 31.0
end
